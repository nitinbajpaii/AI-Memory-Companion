...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-8 relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] bg-primary/20 blur-[150px] rounded-full"></div>
      <div className="absolute bottom-[-10%] left-[-10%] w-[500px] h-[500px] bg-primary/10 blur-[150px] rounded-full"></div>
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400">Continuing your journey of healing.</p>
        </div>
